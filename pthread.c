/****************************************************************************
 *     7/2015 Asher Martin     <ashermartin@gmail.com>
 *
 *   About: serial i/o with threads 
 *          (use i/o hardware at your own risk)
 *
 *   LINUX COMPILE COMMAND: gcc -pthread -o io main.c
 *   OSX COMPILE COMMAND: gcc -o io main.c
 *   TESTED on Linux and with gcc/Xcode 7.0 on OSX
 *
 *   Uses: pthread_create() and signal.h
 *      pthread_create( &readSerialThreadId, NULL, ReadSerialThread, NULL );
 *      pthread_create( &readStdinThreadId, NULL, ReadStdinThread, NULL );
 *
 *   Note: Updated from GPL code.
 *
 ****************************************************************************/
